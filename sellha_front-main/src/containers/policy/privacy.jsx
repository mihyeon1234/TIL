...
function privacy() {
  return (
    <Container>
      <p>
        <span>
          말랑하니 주식회사 (이하 "회사"는) 고객님의 개인정보를 중요시하며,
      ...
      <p>
        ...
        <br />
        가. 수집하는 개인정보의 항목
        <br />o 회사는 회원가입, 상담, 서비스 신청 등을 위해 아래와 같은
        개인정보를 수집하고 있습니다.
        <br />- 회원가입시 : 이름 , 성별 , 로그인ID , 로그인 비밀번호,&nbsp;
        이메일, 전화번호
        <br />- 주문 및 서비스 신청시 : 주소, 결제 정보,
        <span>휴대전화번호</span>
      </p>
      <p>
      ...
      <p>
        나. 수집방법
        <br />- 홈페이지, 서면양식, 게시판, 이메일, 이벤트 응모, 배송요청, 전화,
      ...
      <p>
        ...
        <br />o 마케팅 및 광고에 활용
        <br />
        이벤트 등 광고성 정보 전달 , 접속 빈도 파악 또는 회원의 서비스 이용에
        대한 통계
      </p>
      <p>
        ■ 개인정보의 보유 및 이용기간
      ...
      <p>
        ...
        분쟁해결 및 수사기관의 요청에 따른 협조를 위하여, 이용계약 해지일로부터
        3년간 회원의 정보를 보유할 수 있습니다.
      </p>
      <p>
        나. 관련 법령에 의한 정보 보유 사유 <br />
        전자상거래등에서의소비자보호에관한법률 등 관계법령의 규정에 의하여
        보존할 필요가 있는 경우 회사는 아래와 같이 관계법령에서 정한 일정한 기간
        동안 회원정보를 보관합니다.
        ...
        -보존이유: 전자상거래등에서의소비자보호에관한법률
        <br />
        -보존기간 : 5년 <br />o 소비자 불만 또는 분쟁처리에 관한 기록
        <br />
        -보존이유 : 전자상거래등에서의소비자보호에관한법률
        <br />
      ...
      <p>
        o 위탁 대상자 : 아임포트
        <br />o 위탁업무 내용 : 고객 구독권 관리
      </p>
      <p>
        <br />■ 이용자 및 법정대리인의 권리와 그 행사방법
        <br />o 이용자는 언제든지 등록되어 있는 자신의 개인정보를 조회하거나
        ...
        <br />o 회사는 이용자의 요청에 의해 해지 또는 삭제된 개인정보는 "회사가
      ...
      <p>
        ...
        인터넷 옵션 &gt; 개인정보
        <br />
        3. 단, 귀하께서 쿠키 설치를 거부하였을 경우 서비스 제공에 어려움이 있을
        수 있습니다.
      </p>
      <p>
        <br />
      ...
      <p>
        ...
        전화번호 : 070-7723-1099
        <br />
        이메일 : admin@malanghoney.com
      </p>
      <p>
        <span>o 개인정보보호책임자 </span>
      </p>
      <p>
        성명 : 박성준
        <br />
      ...
      <p>
        ...
        <br />
        대검찰청 사이버범죄수사단 (
        <a href="http://www.spo.go.kr/">www.spo.go.kr</a>&nbsp;/ 02-3480-2000)
        <br />
        경찰청 사이버안전국 (
        <a href="http://www.ctrc.go.kr/">www.ctrc.go.kr/</a>&nbsp;국번 없이 182)
      </p>
    </Container>
  );
}
